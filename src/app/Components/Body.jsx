  ...
  return (
    <div className='space-y-4 lg:flex'>
      ...
      <div className='lg:flex-1 lg:order-1'>
        <h1 className='text-5xl font-bold font-Playfair leading-tight lg:text-[80px]'>Host your website in less than 5 minutes</h1>
        ...
        <form action='' className='flex flex-col gap-4 md:flex-row'>
          <input type='email' className='rounded-md px-4 py-3 placeholder:text-gray-400' placeholder='Please Email Address' />
